...
template <> constexpr inline auto MyButton::qt_create_metaobjectdata<qt_meta_tag_ZN8MyButtonE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'buttontoRemove'
        QtMocHelpers::SignalData<void(MyButton *)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'removebutton'
...
void MyButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->buttontoRemove((*reinterpret_cast< std::add_pointer_t<MyButton*>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MyButton::*)(MyButton * )>(_a, &MyButton::buttontoRemove, 0))
            return;
    }
}
...
// SIGNAL 0
void MyButton::buttontoRemove(MyButton * _t1)
{
